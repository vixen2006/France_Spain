...
import imgFranceHero from "../../imports/Desktop2/france_hero_city.png";
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 overflow-x-hidden">
      ...
      <section className="relative bg-[#fcfdfa] pt-32 pb-0 flex flex-col items-center">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-6 mb-12">
          ...
          <h2 className="text-[32px] md:text-[40px] text-[#111827] font-medium tracking-tight mb-6">
            World-class education. Affordable tuition. €1 degrees exist.
          </h2>
          <p className="text-[15px] md:text-[16px] text-[#2c3eab] font-medium mb-10 max-w-3xl mx-auto leading-relaxed">
            From visa to OFII to your first appartement — your complete guide to studying in France. Visa<br className="hidden md:block"/> calculator, carte de séjour explainer, city explorer, and verified homes.
          </p>
        ...
        <div className="relative w-full h-[400px] md:h-[500px] mt-4 pointer-events-none">
          ...
          <ImageWithFallback 
            src={imgFranceHero}
            alt="Paris aerial view with the Eiffel Tower and River Seine" 
      ...
      <section className="relative z-20 max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { v: '90+', l: 'Universities & Grandes Écoles' },
            { v: '400K+', l: 'International students annually' },
            { v: '6', l: 'Acolyte cities in France' },
            { v: '€400–€1,100', l: 'Average monthly rent range' }
          ].map((stat, i) => (
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 relative mt-12">
        ...
        <div className="border-l-[3px] border-[#3b82f6] pl-6 mb-16 max-w-2xl relative z-10">
          <h3 className="text-[11px] font-bold text-blue-600 tracking-widest uppercase mb-4">Why France</h3>
          ...
          <p className="text-blue-600 font-medium text-base leading-relaxed max-w-xl">
            France is one of the world's most popular study destinations — and for good reason. Here's the honest case for it.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10">
          ...
          <div className="bg-white rounded-[32px] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative overflow-hidden flex flex-col h-full">
            ...
            <h4 className="text-[19px] font-bold text-[#0f172a] mb-3 z-10">Tuition as low as €170/year at public universities.</h4>
            <p className="text-slate-500 text-sm leading-relaxed z-10">
              French public universities charge the same tuition to EU and non-EU students — roughly €170–€380/year for Bachelor's, €243–€380 for Master's. That is not a typo. This is one of the most underrated facts in international education.
            </p>
          </div>
          ...
          <div className="bg-white rounded-[32px] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative overflow-hidden flex flex-col h-full">
            ...
            <h4 className="text-[19px] font-bold text-[#0f172a] mb-3 z-10">French is the 5th most spoken language globally.</h4>
            <p className="text-slate-500 text-sm leading-relaxed z-10">
              French is the official language of 29 countries and is spoken by 300 million people. It opens doors across Africa, Canada, Belgium, Switzerland, and international organisations like the UN and EU.
            </p>
          </div>
          ...
          <div className="bg-white rounded-[32px] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative overflow-hidden flex flex-col h-full">
            <div className="absolute top-8 right-4 text-slate-100 opacity-60 pointer-events-none">
              <Landmark className="w-28 h-28 stroke-[1.5px]" />
            </div>
            <div className="w-12 h-12 bg-blue-50/80 rounded-2xl flex items-center justify-center text-blue-500 mb-8 z-10">
              <Landmark className="w-6 h-6" />
            </div>
            <h4 className="text-[19px] font-bold text-[#0f172a] mb-3 z-10">Grandes Écoles: HEC, Sciences Po, and CentraleSupélec.</h4>
            <p className="text-slate-500 text-sm leading-relaxed z-10">
              France's Grandes Écoles are genuinely elite institutions with global alumni networks. HEC Paris ranks top 5 in Europe for business. Sciences Po produces world leaders. These are target schools that open real doors.
            </p>
          </div>
          ...
          <div className="bg-white rounded-[32px] p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative overflow-hidden flex flex-col h-full">
            ...
            <h4 className="text-[19px] font-bold text-[#0f172a] mb-3 z-10">Sécu — the world's best healthcare system, included.</h4>
            <p className="text-slate-500 text-sm leading-relaxed z-10">
              All students in France get access to the Sécurité Sociale (French national health insurance). GP visits are €25, most of which is reimbursed. France consistently ranks #1 in global healthcare quality.
            </p>
          </div>
          ...
          <div className="bg-[#233876] rounded-[32px] p-8 shadow-[0_12px_40px_rgb(35,56,118,0.3)] relative overflow-hidden flex flex-col sm:flex-row items-start gap-6 h-full md:col-span-2">
            ...
            <div>
              <h4 className="text-[19px] font-bold text-white mb-3">The honest bit: French bureaucracy and the OFII process.</h4>
              <p className="text-blue-100/90 text-sm leading-relaxed">
                France has famously complex administrative processes. After arrival you must complete your OFII procedure (validate your visa), get your titre de séjour (residence permit), and register with CAF for housing aid. Each of these involves queues, documents, and waiting. <strong className="text-white">Start the OFII process the week you arrive — do not delay.</strong>
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-[#141a38] text-white pt-32 pb-10 border-t border-white/5 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <h2 className="text-[44px] md:text-[56px] font-bold mb-5 tracking-tight leading-[1.05]">
            Ready to find your<br/>home in France?
          </h2>
          <p className="text-[17px] text-[#8e9bbd] mb-12 font-medium">
            Every listing verified. Every CAF-eligible property. Support from day one.
          </p>
